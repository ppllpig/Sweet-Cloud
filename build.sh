...
FetchWebDev() {
  curl -L https://codeload.github.com/li-peifeng/casadolce-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/li-peifeng/casadolce-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
