...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.SiteTitle, Value: "Sweet • Cloud", Type: conf.TypeString, Group: model.SITE},
		{Key: conf.Announcement, Value: "Welcome To Sweet • Cloud", Type: conf.TypeText, Group: model.SITE},
...
(?U)access_token=(.*)&`,
		...
		{Key: conf.LdapLoginTips, Value: "使用 LDAP 登录", Type: conf.TypeString, Group: model.LDAP, Flag: model.PUBLIC},
